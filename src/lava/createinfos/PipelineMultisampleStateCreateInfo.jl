struct PipelineMultisampleStateCreateInfo
    ...
    function PipelineMultisampleStateCreateInfo(reserve::Vector{Any} = [];
        ...
        flags::vk.VkPipelineMultisampleStateCreateFlags = 0,
        rasterizationSamples::vk.VkSampleCountFlagBits = 0,
        sampleShadingEnable::vk.VkBool32 = vk.VK_FALSE,
        minSampleShading::Cfloat = 0,
        pSampleMask::Ptr{vk.VkSampleMask} = C_NULL,
        alphaToCoverageEnable::vk.VkBool32 = vk.VK_FALSE,
        alphaToOneEnable::vk.VkBool32 = vk.VK_FALSE
    )
